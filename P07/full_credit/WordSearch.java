...
public class WordSearch {
    ...
    public void solve() 
    {
        ...
        for(int i =0; i < NUM_THREADS; i++)
        {
            ...
            threadObjects.add(new Thread(()->solve(threadNo, start, end)));
        ...
        for(int i =0; i<NUM_THREADS; i++)
        {
            ...
            {
                //nothing is done with any caught exceptions if join() throws exception
            }
        }
    ...
    {
        System.err.println("Thread " + threadNo + ": " + firstPuzzle + "-" + (lastPuzzlePlusOne-1));
